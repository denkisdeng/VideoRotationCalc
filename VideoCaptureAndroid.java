...
public class VideoCaptureAndroid implements PreviewCallback, Callback {
  ...
  public static void setFlashMode(boolean mode)
  {
	  flashmode = mode;
  }
...
private void startCaptureOnCameraThread(
    ...
    try {
      ...
      Log.i(TAG, "Camera width: " + width + " height: " + height);
//      width = 640;
//      height = 480;
...
//  Log.i(TAG, "onPreviewFrame rotation = " + rotation + " info.orientation = " + info.orientation);
    
    ProvideCameraFrame(data, data.length, rotation,
        captureTimeMs, native_capturer);
    
    // for next frame data callback
    camera.addCallbackBuffer(data);
  }
  ...
  private void setPreviewRotationOnCameraThread(
    ...
    Log.i(TAG, "setPreviewRotation:" + rotation);
